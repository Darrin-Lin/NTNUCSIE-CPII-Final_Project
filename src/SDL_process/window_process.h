...
#define AVATAR_BG_COLOR    \
    {                      \
        230, 127, 80, 0xFF \
    }
#define CHARACTER_NAME_BG_HEIGHT 50
#define CHARACTER_NAME_BG_COLOR \
    {                           \
        244, 164, 96, 0xFF      \
    }
...
#define HELP_MESSAGES                                                                                                                                                                                                                \
    {                                                                                                                                                                                                                                \
        "[SPACE] : continue, select option", "[ESC] : back to novel page", "[↑] : option select up", "[↓] : option select down", "[ENTER] : setting bar select", "[→] : setting bar option right", "[←] : setting bar option left" \
    }
